...
public class XinZengWS extends BaseActivity {

    private Button btn_register,btn2;
    private EditText editText1,editText2,et12;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xzws);
    ...
    private void register(String user_name,String password) {
        ...
        ajaxParams.put("salt", GlobalVars.getSafe(context));
            ...
            public void onSuccess(String s) {
                ...
                try {
                    ...
                    if (object.getInt("result")==1){
                        Tools.showTextToast(context,"新增成功");
                    }else {
