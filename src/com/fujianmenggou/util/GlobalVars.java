...
public class GlobalVars {
	...
	public final static String versionUrl = baseUrl
			+ "/json/json.aspx?op=Version&Version_Type=1";
	public final static String appDownloadUrl = baseUrl + "/app/";

	public final static String agree_url = baseUrl
			+ "/json/json.aspx?op=Agreement";
	...
	public static String getUid(Context context) {
		SharedPreferences share = context.getSharedPreferences("GLOBALVARS",
